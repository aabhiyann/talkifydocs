...
const variants = {
  ...
  elevated: "bg-white dark:bg-secondary-800 shadow-medium border border-secondary-200 dark:border-secondary-700",
  glass: "glass bg-white/60 dark:bg-secondary-800/60 backdrop-blur-sm border border-primary-100/50 dark:border-primary-700/50",
  gradient: "bg-gradient-to-br from-white to-primary-50 dark:from-secondary-800 dark:to-primary-900/20 border border-primary-200/50 dark:border-primary-700/50",
};
