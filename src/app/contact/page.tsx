  ...
  const faqs = [
    {
      ...
      answer: "Simply sign up for a free account, upload your first PDF document, and start asking questions. Our AI will process your document and you can begin chatting with it immediately."
    },
    {
      question: "What file formats are supported?",
      answer: "Currently, we support PDF documents. We're working on adding support for Word documents, PowerPoint presentations, and other formats in the coming months."
    },
    {
      question: "Is my data secure?",
      answer: "Yes, absolutely. We use enterprise-grade encryption, comply with SOC 2 standards, and never share your documents with third parties. Your data privacy is our top priority."
    },
    {
      question: "Can I use TalkifyDocs for team collaboration?",
      answer: "Yes! Our Pro plan includes team features that allow you to share documents with team members, collaborate on conversations, and manage access permissions."
    },
    {
      question: "What's the difference between Free and Pro plans?",
      answer: "The Free plan includes 5 pages per PDF and basic features. The Pro plan offers unlimited pages, advanced AI features, team collaboration, priority support, and more."
    },
    {
      question: "How accurate are the AI responses?",
      answer: "Our AI provides highly accurate responses based on your document content. The accuracy depends on the quality and clarity of the source document, but we continuously improve our models."
    }
  ];
        ...
        <MaxWidthWrapper>
          <div className="text-center">
            ...
            <p className="text-body-lg text-secondary-600 dark:text-secondary-300 max-w-3xl mx-auto leading-relaxed">
              ...
              to get the most out of TalkifyDocs.
            </p>
          </div>
        </MaxWidthWrapper>
      </section>
